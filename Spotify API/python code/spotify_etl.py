...
def run_spotify_etl():
    ...
    client_id = "f1280a0760ab46b7a672e06aaa212e9c"
    client_secret = "6cbe940567cd418896c17f1f7c66e9b5"
# Provide details for authentication to extract data from spotify
    ...
    playlist_link = "https://open.spotify.com/playlist/3BRoMhkG61fgnU5yw4NOaK"
    ...
    for row in data['items']:
        ...
        song_dict = {'song_id':song_id,'song_name':song_name,'duration_ms':song_duration,'url':song_url,'popularity':song_popularity,'song_added':song_added,'album_id':album_id,'artist_id':artist_id}
    ...
    album_df.to_csv("s3://spotifydataelt/album.csv")
    artist_df.to_csv("s3://spotifydataetl/artist_df.csv")
    song_df.to_csv("s3://spotifydataetl/song_df.csv")